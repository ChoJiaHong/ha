...
sudo kubeadm join 10.52.52.111:6443 --token wzc8tn.yv25mm1li8lj1wlv \
        --discovery-token-ca-cert-hash sha256:a15c8cb0d5a2bcf1f324d44eb1803abc0eb53a3ad43683a6ecfce3c272df3677 
...
sudo scp hiro@10.52.52.111:/etc/kubernetes/admin.conf /etc/kubernetes/admin.conf
